...
#' @param roundDigits rounding digits for the results. Default is 4
#' @import dplyr
#' @author Shubhram Pandey \email {shubhram1992@@gmail.com}
#' @export metaHistoric
metaHistoric = function(data = read.csv("data/sampleDataHistoric.csv"),
                        method = "beggPilote", alpha = 0.95, roundDigits = 4){
